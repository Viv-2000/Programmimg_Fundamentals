    ...
    def display_students(self, reports_file_name):
        ...
        for student in self.students:
            if student.get_student_type() == 'PG':
                ...
                sys.stdout.write('{:<15}{:<10}{:>10}{:>10}{:>15.2f}{:>10.2f}{:>12}{:>12}'.format(student.get_student_ID(), student.get_student_name(), student.get_student_type(), student.get_student_mode(), GPA100, GPA4, n_finish, non_going))
                report_file.write('{:<15}{:<10}{:>10}{:>10}{:>15.2f}{:>10.2f}{:>12}{:>12}'.format(student.get_student_ID(), student.get_student_name(), student.get_student_type(), student.get_student_mode(), GPA100, GPA4, n_finish, non_going))
                print()
                report_file.write('\n')            
