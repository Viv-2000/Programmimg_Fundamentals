...
def get_list(prompt):                                   #get_list is a function to let the user input a string of comma seperated elements
    ...
    while True:                                         #while loop to ensure user doesn't enter a blank list
        try:
            ...
            if len(input_string) == 0:                  #if condition to ensure input is not blank
                print('Sorry, input cannot be blank')
            else:
                input_list = [x.strip().title() for x in input_string.split(",")]     #string comprehension combined with str.title() and str.split() to 
                                                                                      #split the string and strip its individual components off spaces
...
#................................................................................................................................................................
    ...
    def add_movies(self):                   #this function asks user to enter a list of new movies, and adds the new movie if they do not already exist    
        ...
        for new_movie_name in new_movie_list:               #for loop number 1: it iterates through the entered movie list
            for movie in self.movies:                       #nested for loop: it iterates through the existing movies list
                if new_movie_name == movie.get_name():      #if condition checks whether new movie exists already or not, and conveys corresponding message
                    print(f"The movie '{new_movie_name}' already exists in the system.")
                    break                                   #if  movie exists, then nested loop is skipped and next item in enetered movie list is processed
            else:                                           #if there is no match in the nested for loop, then this else statement is executed                  
                ...
                print(f'New movie {new_movie_name} with a new ID {new_movie.get_ID()} has been added to the system with 50 seats.')
...
#................................................................................................................................................................
    ...
    def adjust_disc_rate_Flat(self):
